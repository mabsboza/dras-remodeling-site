export const site = {
  ...
  address: 'Atlanta, GA & surrounding areas',
  socials: { instagram: 'https://www.instagram.com/odaratradegroup', facebook: 'https://www.facebook.com/yuimaginewemake' }
};

export const services = [
  { slug: 'kitchens', title: 'Kitchen Remodeling', image: '/images/kitchen/kitchen2.jpeg', description: 'Custom cabinetry, countertops, islands, lighting and complete layout upgrades.' },
  { slug: 'bathrooms', title: 'Bathroom Remodeling', image: '/images/bath/bath1.jpeg', description: 'Elegant tile, showers, vanities, flooring and modern fixture installation.' },
  { slug: 'full-renovations', title: 'Full Home Renovation', image: '/images/home/fullhome.jpeg', description: 'Room-by-room transformations with planning, demolition, buildout and finish work.' },
  { slug: 'flooring', title: 'Flooring & More', image: '/images/floor/floor.jpeg', description: 'Hardwood, tile, laminate, trim, painting, repairs and finishing details.' }
];
...
export const featuredProjects = [
  ...
  },
  {
    ...
    image: '/images/project-floor.svg',
  ...
  },
  {
    ...
    image: '/images/project-living.svg',
